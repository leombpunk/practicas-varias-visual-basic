Module ejercicio4_13
    'Crear un algoritmo con la misma consigna que el ejercicio 4.7 pero utilizando List(of T).
    'Crear un algoritmo para almacenar las notas (0 a 10) de una serie de alumnos.
